                        ...
                        <table class="table table hover">
                            ...
                            <tbody>
                                ...
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <td><input type="number" name="txtCantidad" id="txtCantidad" class="form-control" style="width: 60px;" min="1" value=" {{ $carrito->cantidad }}">
                                    </td>

                                    <td>

                                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                            <button type="submit" class="btn btn-success "><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-repeat" viewBox="0 0 15 15">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6" style="text-align: right;">
                                            ...
                                            <a href="/takeaway">
                                                <button type="submit" class="btn btn-warning" style="background-color:#ffbe33; color:#ffffff; border-radius:45px;">Agregar productos</button>
                                            </a>
