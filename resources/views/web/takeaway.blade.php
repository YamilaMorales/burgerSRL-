              ...
              <div class="detail-box">
                ...
                <div class="options ">
                  ...
                  <form action="" method="POST">
                    ...
                    <button type="submit" class="btn_ox"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart-fill" style="enable-background:new 0 0 456.029 456.029;" viewBox="0 0 16 16">
